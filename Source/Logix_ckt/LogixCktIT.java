...
abstract class LogixCktIT {
   boolean on, selected;
   public FloatRect boundingBox = new FloatRect();
   ...
   LogixNub getLineSource(int x, int y) { return null; }
   LogixNub getLineDestination(int x, int y) { return null; }
   ...
   abstract LogixCktIT copy();
   abstract void delete(LogixCkt owner);
   abstract void unDelete(LogixCkt owner);
}
